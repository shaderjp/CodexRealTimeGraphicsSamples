...
namespace
{
    ...
    const std::array<const wchar_t*, SciFiHelmetVulkan::TextureCount> TextureNames =
    {
...
bool SciFiHelmetVulkan::QueueFamilyIndices::IsComplete() const
{
    return graphicsFamily != UINT32_MAX && presentFamily != UINT32_MAX;
}

SciFiHelmetVulkan::SciFiHelmetVulkan(uint32_t width, uint32_t height, const wchar_t* title) :
    m_width(width),
    m_height(height),
    m_title(title)
{
...
SciFiHelmetVulkan::~SciFiHelmetVulkan()
{
    Cleanup();
}

int SciFiHelmetVulkan::Run(HINSTANCE instance, int showCommand)
{
...
LRESULT CALLBACK SciFiHelmetVulkan::WindowProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
...
void SciFiHelmetVulkan::InitWindow(HINSTANCE instance, int showCommand)
{
    ...
    windowClass.lpszClassName = L"SciFiHelmetVulkanWindowClass";
...
void SciFiHelmetVulkan::InitVulkan()
{
    LoadModel();
    CreateInstance();
    CreateSurface();
...
void SciFiHelmetVulkan::MainLoop()
{
    MSG message{};
...
void SciFiHelmetVulkan::WaitIdle()
{
...
void SciFiHelmetVulkan::Cleanup()
{
    if (m_device != VK_NULL_HANDLE)
    {
        vkDeviceWaitIdle(m_device);
...
void SciFiHelmetVulkan::CreateInstance()
{
    VkApplicationInfo appInfo{};
    appInfo.sType = VK_STRUCTURE_TYPE_APPLICATION_INFO;
    appInfo.pApplicationName = "SciFiHelmet Vulkan";
...
void SciFiHelmetVulkan::CreateSurface()
{
...
void SciFiHelmetVulkan::PickPhysicalDevice()
{
...
void SciFiHelmetVulkan::CreateLogicalDevice()
{
...
void SciFiHelmetVulkan::CreateSwapChain()
{
...
void SciFiHelmetVulkan::CreateImageViews()
{
...
void SciFiHelmetVulkan::CreateRenderPass()
{
...
void SciFiHelmetVulkan::CreateDescriptorSetLayout()
{
...
void SciFiHelmetVulkan::CreateGraphicsPipeline()
{
    std::wstring shaderDirectory = GetExecutableDirectory();
    VkShaderModule vertexShaderModule = CreateShaderModule(ReadFile(shaderDirectory + L"SciFiHelmet.vs.spv"));
    VkShaderModule pixelShaderModule = CreateShaderModule(ReadFile(shaderDirectory + L"SciFiHelmet.ps.spv"));
...
void SciFiHelmetVulkan::CreateDepthResources()
{
...
void SciFiHelmetVulkan::CreateFramebuffers()
{
...
void SciFiHelmetVulkan::CreateCommandPool()
{
...
void SciFiHelmetVulkan::LoadModel()
{
...
void SciFiHelmetVulkan::CreateVertexBuffer()
{
...
void SciFiHelmetVulkan::CreateIndexBuffer()
{
...
void SciFiHelmetVulkan::CreateTextureImages()
{
    for (uint32_t i = 0; i < TextureCount; ++i)
    {
...
void SciFiHelmetVulkan::CreateTextureSampler()
{
...
void SciFiHelmetVulkan::CreateUniformBuffer()
{
...
void SciFiHelmetVulkan::CreateDescriptorPool()
{
...
void SciFiHelmetVulkan::CreateDescriptorSet()
{
...
void SciFiHelmetVulkan::CreateCommandBuffers()
{
...
void SciFiHelmetVulkan::CreateSyncObjects()
{
...
void SciFiHelmetVulkan::UpdateUniformBuffer()
{
    ...
    constants.lightColor = XMFLOAT4(1.0f, 0.96f, 0.88f, 5.0f);
...
bool SciFiHelmetVulkan::IsDeviceSuitable(VkPhysicalDevice device) const
{
...
SciFiHelmetVulkan::QueueFamilyIndices SciFiHelmetVulkan::FindQueueFamilies(VkPhysicalDevice device) const
{
...
SciFiHelmetVulkan::SwapChainSupport SciFiHelmetVulkan::QuerySwapChainSupport(VkPhysicalDevice device) const
{
...
VkSurfaceFormatKHR SciFiHelmetVulkan::ChooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& formats) const
{
...
VkPresentModeKHR SciFiHelmetVulkan::ChooseSwapPresentMode(const std::vector<VkPresentModeKHR>& presentModes) const
{
...
VkExtent2D SciFiHelmetVulkan::ChooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) const
{
...
uint32_t SciFiHelmetVulkan::FindMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) const
{
...
void SciFiHelmetVulkan::CreateBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& memory)
{
...
void SciFiHelmetVulkan::CreateImage(uint32_t width, uint32_t height, VkFormat format, VkImageUsageFlags usage, VkImage& image, VkDeviceMemory& memory)
{
...
VkImageView SciFiHelmetVulkan::CreateImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) const
{
...
VkCommandBuffer SciFiHelmetVulkan::BeginSingleTimeCommands() const
{
    VkCommandBufferAllocateInfo allocateInfo{};
    allocateInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
    allocateInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
...
void SciFiHelmetVulkan::EndSingleTimeCommands(VkCommandBuffer commandBuffer) const
{
...
void SciFiHelmetVulkan::CopyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) const
{
...
void SciFiHelmetVulkan::TransitionImageLayout(VkImage image, VkImageLayout oldLayout, VkImageLayout newLayout) const
{
    VkCommandBuffer commandBuffer = BeginSingleTimeCommands();
...
SciFiHelmetVulkan::ImageData SciFiHelmetVulkan::LoadTexture(const std::wstring& path) const
{
    ...
    {
        throw std::runtime_error("Failed to load SciFiHelmet texture.");
    }
...
std::vector<char> SciFiHelmetVulkan::ReadFile(const std::wstring& path) const
{
...
VkShaderModule SciFiHelmetVulkan::CreateShaderModule(const std::vector<char>& code) const
{
...
std::wstring SciFiHelmetVulkan::GetExecutableDirectory() const
{
...
void SciFiHelmetVulkan::ThrowIfFailed(VkResult result, const char* message) const
{
