...
The `Bistro Controls` ImGui window exposes a `Debug View` combo box. It can switch the renderer from the final shaded image to intermediate views used for API comparison and shader debugging.
