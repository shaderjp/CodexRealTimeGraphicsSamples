#include "stdafx.h"
#include "BistroExteriorShadowD3D12.h"
...
BistroExteriorShadowD3D12::BistroExteriorShadowD3D12(UINT width, UINT height, std::wstring name) :
...
void BistroExteriorShadowD3D12::OnInit()
{
    LoadPipeline();
    LoadAssets();
...
void BistroExteriorShadowD3D12::LoadPipeline()
{
...
void BistroExteriorShadowD3D12::LoadAssets()
{
...
void BistroExteriorShadowD3D12::CreateRootSignature()
{
    ...
    CD3DX12_ROOT_PARAMETER rootParameters[3 + Bistro::TextureSlotCount];
    ...
    rootParameters[2 + Bistro::TextureSlotCount].InitAsDescriptorTable(1, &shadowRange, D3D12_SHADER_VISIBILITY_PIXEL);
...
void BistroExteriorShadowD3D12::CreatePipelineState()
{
    ...
    ThrowIfFailed(ReadDataFromFile((exeDir + L"BistroExteriorShadow.vs.cso").c_str(), &vertexShaderData, &vertexShaderSize));
    ThrowIfFailed(ReadDataFromFile((exeDir + L"BistroExteriorShadow.ps.cso").c_str(), &pixelShaderData, &pixelShaderSize));
    ThrowIfFailed(ReadDataFromFile((exeDir + L"BistroExteriorShadow.shadow.vs.cso").c_str(), &shadowVertexShaderData, &shadowVertexShaderSize));
    ThrowIfFailed(ReadDataFromFile((exeDir + L"BistroExteriorShadow.shadow.ps.cso").c_str(), &shadowPixelShaderData, &shadowPixelShaderSize));
...
void BistroExteriorShadowD3D12::CreateBuffers()
{
...
void BistroExteriorShadowD3D12::CreateShadowResources()
{
...
UINT BistroExteriorShadowD3D12::CreateTextureResource(const std::wstring& path, bool srgb, const uint8_t fallback[4], std::map<std::wstring, UINT>& cache)
{
...
void BistroExteriorShadowD3D12::CreateTextures()
{
...
void BistroExteriorShadowD3D12::OnUpdate()
{
    BuildUI();
...
void BistroExteriorShadowD3D12::UpdateConstantBuffer(float deltaSeconds)
{
...
void BistroExteriorShadowD3D12::OnRender()
{
    PopulateCommandList();
    ID3D12CommandList* commandLists[] = { m_commandList.Get() };
    m_commandQueue->ExecuteCommandLists(_countof(commandLists), commandLists);
...
void BistroExteriorShadowD3D12::PopulateCommandList()
{
    ...
    m_commandList->SetGraphicsRootDescriptorTable(2 + Bistro::TextureSlotCount, shadowSrvHandle);
    DrawScene();
...
void BistroExteriorShadowD3D12::DrawScene()
{
...
void BistroExteriorShadowD3D12::OnDestroy()
{
    WaitForPreviousFrame();
    ShutdownImGui();
...
void BistroExteriorShadowD3D12::WaitForPreviousFrame()
{
...
void BistroExteriorShadowD3D12::ResizeOutput(UINT width, UINT height)
{
...
void BistroExteriorShadowD3D12::OnKeyDown(UINT8 key)
{
    if (key == VK_ESCAPE)
    {
...
void BistroExteriorShadowD3D12::OnWindowMessage(UINT message, WPARAM wParam, LPARAM lParam)
{
...
void BistroExteriorShadowD3D12::InitializeImGui()
{
    IMGUI_CHECKVERSION();
    ImGui::CreateContext();
...
void BistroExteriorShadowD3D12::ShutdownImGui()
{
...
void BistroExteriorShadowD3D12::BuildUI()
{
...
void BistroExteriorShadowD3D12::BuildRendererStatsUI()
{
...
void BistroExteriorShadowD3D12::ResetLight()
{
...
void BistroExteriorShadowD3D12::ResetCameraView()
{
    m_camera.Reset(m_defaultCameraPosition, m_defaultCameraYaw, m_defaultCameraPitch);
}

void BistroExteriorShadowD3D12::ResetCameraSpeeds()
{
    m_baseMoveSpeed = 17.0f;
    m_fastMoveSpeed = 58.2f;
}

void BistroExteriorShadowD3D12::ResetShadowSettings()
{
...
void BistroExteriorShadowD3D12::AllocateImGuiDescriptor(ImGui_ImplDX12_InitInfo* info, D3D12_CPU_DESCRIPTOR_HANDLE* outCpuHandle, D3D12_GPU_DESCRIPTOR_HANDLE* outGpuHandle)
{
    auto* sample = static_cast<BistroExteriorShadowD3D12*>(info->UserData);
...
void BistroExteriorShadowD3D12::FreeImGuiDescriptor(ImGui_ImplDX12_InitInfo*, D3D12_CPU_DESCRIPTOR_HANDLE, D3D12_GPU_DESCRIPTOR_HANDLE)
{
}
