...
BistroExteriorD3D12::BistroExteriorD3D12(UINT width, UINT height, std::wstring name) :
...
void BistroExteriorD3D12::OnInit()
{
    LoadPipeline();
    LoadAssets();
...
void BistroExteriorD3D12::LoadPipeline()
{
...
void BistroExteriorD3D12::LoadAssets()
{
...
void BistroExteriorD3D12::CreatePipelineState()
{
...
void BistroExteriorD3D12::CreateBuffers()
{
...
UINT BistroExteriorD3D12::CreateTextureResource(const std::wstring& path, bool srgb, const uint8_t fallback[4], std::map<std::wstring, UINT>& cache)
{
...
void BistroExteriorD3D12::CreateTextures()
{
...
void BistroExteriorD3D12::OnUpdate()
{
    BuildUI();
...
void BistroExteriorD3D12::UpdateConstantBuffer(float deltaSeconds)
{
...
void BistroExteriorD3D12::OnRender()
{
    PopulateCommandList();
    ID3D12CommandList* commandLists[] = { m_commandList.Get() };
    m_commandQueue->ExecuteCommandLists(_countof(commandLists), commandLists);
...
void BistroExteriorD3D12::PopulateCommandList()
{
...
void BistroExteriorD3D12::OnDestroy()
{
    WaitForPreviousFrame();
    ShutdownImGui();
...
void BistroExteriorD3D12::WaitForPreviousFrame()
{
...
void BistroExteriorD3D12::ResizeOutput(UINT width, UINT height)
{
...
void BistroExteriorD3D12::OnKeyDown(UINT8 key)
{
    if (key == VK_ESCAPE)
    {
...
void BistroExteriorD3D12::OnWindowMessage(UINT message, WPARAM wParam, LPARAM lParam)
{
...
void BistroExteriorD3D12::InitializeImGui()
{
    IMGUI_CHECKVERSION();
    ImGui::CreateContext();
...
void BistroExteriorD3D12::ShutdownImGui()
{
...
void BistroExteriorD3D12::BuildUI()
{
...
void BistroExteriorD3D12::ResetCameraView()
{
...
{
    auto* sample = static_cast<BistroExteriorD3D12*>(info->UserData);
...
void BistroExteriorD3D12::FreeImGuiDescriptor(ImGui_ImplDX12_InitInfo*, D3D12_CPU_DESCRIPTOR_HANDLE, D3D12_GPU_DESCRIPTOR_HANDLE)
{
}
