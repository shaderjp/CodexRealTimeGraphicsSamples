...
class BistroExteriorMeshShaderShadowCullingVulkan
{
public:
    BistroExteriorMeshShaderShadowCullingVulkan(uint32_t width, uint32_t height, const wchar_t* title);
...
private:
    ...
    struct SceneConstants
    {
        ...
        DirectX::XMFLOAT4 lightFrustumPlanes[6];
    };
    ...
    VkBuffer m_meshletBoundsBuffer = VK_NULL_HANDLE;
    VkDeviceMemory m_meshletBoundsBufferMemory = VK_NULL_HANDLE;
    ...
    DirectX::XMFLOAT3 m_defaultCameraPosition = DirectX::XMFLOAT3(0.0f, 3.0f, -10.0f);
    ...
    uint32_t m_lastShadowVisibleMeshlets = 0;
