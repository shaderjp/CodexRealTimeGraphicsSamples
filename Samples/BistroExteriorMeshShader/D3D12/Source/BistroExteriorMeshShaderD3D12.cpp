#include "stdafx.h"
#include "BistroExteriorMeshShaderD3D12.h"
...
namespace
{
    ...
    constexpr UINT RootParameterMeshletDrawConstants = 6;
    constexpr UINT RootParameterTextureBase = 7;
    constexpr UINT MaxDispatchMeshThreadGroupsX = 65535;
}

BistroExteriorMeshShaderD3D12::BistroExteriorMeshShaderD3D12(UINT width, UINT height, std::wstring name) :
...
void BistroExteriorMeshShaderD3D12::OnInit()
{
    LoadPipeline();
    LoadAssets();
...
void BistroExteriorMeshShaderD3D12::LoadPipeline()
{
    ...
    {
        throw std::runtime_error("This GPU/driver does not support Direct3D 12 Mesh Shader Tier 1. BistroExteriorMeshShaderD3D12 has no vertex-shader fallback.");
    }
...
void BistroExteriorMeshShaderD3D12::LoadAssets()
{
...
void BistroExteriorMeshShaderD3D12::CreateRootSignature()
{
...
void BistroExteriorMeshShaderD3D12::CreatePipelineState()
{
    ...
    ThrowIfFailed(ReadDataFromFile((exeDir + L"BistroExteriorMeshShader.ms.cso").c_str(), &meshShaderData, &meshShaderSize));
    ThrowIfFailed(ReadDataFromFile((exeDir + L"BistroExteriorMeshShader.ps.cso").c_str(), &pixelShaderData, &pixelShaderSize));
...
void BistroExteriorMeshShaderD3D12::CreateBuffers()
{
...
UINT BistroExteriorMeshShaderD3D12::CreateTextureResource(const std::wstring& path, bool srgb, const uint8_t fallback[4], std::map<std::wstring, UINT>& cache)
{
...
void BistroExteriorMeshShaderD3D12::CreateTextures()
{
...
void BistroExteriorMeshShaderD3D12::OnUpdate()
{
    BuildUI();
...
void BistroExteriorMeshShaderD3D12::UpdateConstantBuffer(float deltaSeconds)
{
...
void BistroExteriorMeshShaderD3D12::OnRender()
{
    PopulateCommandList();
    ID3D12CommandList* commandLists[] = { m_commandList.Get() };
    m_commandQueue->ExecuteCommandLists(_countof(commandLists), commandLists);
...
void BistroExteriorMeshShaderD3D12::PopulateCommandList()
{
    ...
    for (const Bistro::MeshletDispatchRange& range : m_scene.meshletDispatchRanges)
    {
        ...
        {
            const UINT dispatchCount = (std::min)(meshletsRemaining, MaxDispatchMeshThreadGroupsX);
...
void BistroExteriorMeshShaderD3D12::OnDestroy()
{
    WaitForPreviousFrame();
    ShutdownImGui();
...
void BistroExteriorMeshShaderD3D12::WaitForPreviousFrame()
{
...
void BistroExteriorMeshShaderD3D12::ResizeOutput(UINT width, UINT height)
{
...
void BistroExteriorMeshShaderD3D12::OnKeyDown(UINT8 key)
{
    if (key == VK_ESCAPE)
    {
...
void BistroExteriorMeshShaderD3D12::OnWindowMessage(UINT message, WPARAM wParam, LPARAM lParam)
{
...
void BistroExteriorMeshShaderD3D12::InitializeImGui()
{
    IMGUI_CHECKVERSION();
    ImGui::CreateContext();
...
void BistroExteriorMeshShaderD3D12::ShutdownImGui()
{
...
void BistroExteriorMeshShaderD3D12::BuildUI()
{
...
void BistroExteriorMeshShaderD3D12::BuildRendererStatsUI()
{
...
void BistroExteriorMeshShaderD3D12::ResetLight()
{
...
void BistroExteriorMeshShaderD3D12::ResetCameraView()
{
    m_camera.Reset(m_defaultCameraPosition, m_defaultCameraYaw, m_defaultCameraPitch);
}

void BistroExteriorMeshShaderD3D12::ResetCameraSpeeds()
{
    m_baseMoveSpeed = 17.0f;
    m_fastMoveSpeed = 58.2f;
}

void BistroExteriorMeshShaderD3D12::AllocateImGuiDescriptor(ImGui_ImplDX12_InitInfo* info, D3D12_CPU_DESCRIPTOR_HANDLE* outCpuHandle, D3D12_GPU_DESCRIPTOR_HANDLE* outGpuHandle)
{
    auto* sample = static_cast<BistroExteriorMeshShaderD3D12*>(info->UserData);
...
void BistroExteriorMeshShaderD3D12::FreeImGuiDescriptor(ImGui_ImplDX12_InitInfo*, D3D12_CPU_DESCRIPTOR_HANDLE, D3D12_GPU_DESCRIPTOR_HANDLE)
{
}
