...
Invoke-WithMutex -Name "Local\CodexdBistroExteriorMeshShaderAssimp-$Configuration" -Body {
...
Invoke-WithMutex -Name "Local\CodexdBistroExteriorMeshShaderDirectXTex-$Configuration" -Body {
