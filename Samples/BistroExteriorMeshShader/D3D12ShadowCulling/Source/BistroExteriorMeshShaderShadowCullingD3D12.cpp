#include "stdafx.h"
#include "BistroExteriorMeshShaderShadowCullingD3D12.h"
...
BistroExteriorMeshShaderShadowCullingD3D12::BistroExteriorMeshShaderShadowCullingD3D12(UINT width, UINT height, std::wstring name) :
...
void BistroExteriorMeshShaderShadowCullingD3D12::OnInit()
{
    LoadPipeline();
    LoadAssets();
...
void BistroExteriorMeshShaderShadowCullingD3D12::LoadPipeline()
{
    ...
    {
        throw std::runtime_error("This GPU/driver does not support Direct3D 12 Mesh Shader Tier 1. BistroExteriorMeshShaderShadowCullingD3D12 has no vertex-shader fallback.");
    }
...
void BistroExteriorMeshShaderShadowCullingD3D12::LoadAssets()
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::CreateRootSignature()
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::CreatePipelineState()
{
    ...
    ThrowIfFailed(ReadDataFromFile((exeDir + L"BistroExteriorMeshShaderShadowCulling.as.cso").c_str(), &amplificationShaderData, &amplificationShaderSize));
    ThrowIfFailed(ReadDataFromFile((exeDir + L"BistroExteriorMeshShaderShadowCulling.ms.cso").c_str(), &meshShaderData, &meshShaderSize));
    ThrowIfFailed(ReadDataFromFile((exeDir + L"BistroExteriorMeshShaderShadowCulling.ps.cso").c_str(), &pixelShaderData, &pixelShaderSize));
    ThrowIfFailed(ReadDataFromFile((exeDir + L"BistroExteriorMeshShaderShadowCulling.shadow.ms.cso").c_str(), &shadowMeshShaderData, &shadowMeshShaderSize));
    ThrowIfFailed(ReadDataFromFile((exeDir + L"BistroExteriorMeshShaderShadowCulling.shadow.ps.cso").c_str(), &shadowPixelShaderData, &shadowPixelShaderSize));
...
void BistroExteriorMeshShaderShadowCullingD3D12::CreateBuffers()
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::CreateShadowResources()
{
...
UINT BistroExteriorMeshShaderShadowCullingD3D12::CreateTextureResource(const std::wstring& path, bool srgb, const uint8_t fallback[4], std::map<std::wstring, UINT>& cache)
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::CreateTextures()
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::OnUpdate()
{
    BuildUI();
...
void BistroExteriorMeshShaderShadowCullingD3D12::UpdateConstantBuffer(float deltaSeconds)
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::OnRender()
{
    PopulateCommandList();
    ID3D12CommandList* commandLists[] = { m_commandList.Get() };
    m_commandQueue->ExecuteCommandLists(_countof(commandLists), commandLists);
...
void BistroExteriorMeshShaderShadowCullingD3D12::PopulateCommandList()
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::DrawScene(bool shadowPass)
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::OnDestroy()
{
    WaitForPreviousFrame();
    ShutdownImGui();
...
void BistroExteriorMeshShaderShadowCullingD3D12::WaitForPreviousFrame()
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::ResizeOutput(UINT width, UINT height)
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::OnKeyDown(UINT8 key)
{
    if (key == VK_ESCAPE)
    {
...
void BistroExteriorMeshShaderShadowCullingD3D12::OnWindowMessage(UINT message, WPARAM wParam, LPARAM lParam)
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::InitializeImGui()
{
    IMGUI_CHECKVERSION();
    ImGui::CreateContext();
...
void BistroExteriorMeshShaderShadowCullingD3D12::ShutdownImGui()
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::BuildUI()
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::BuildRendererStatsUI()
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::ResetLight()
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::ResetCameraView()
{
    m_camera.Reset(m_defaultCameraPosition, m_defaultCameraYaw, m_defaultCameraPitch);
}

void BistroExteriorMeshShaderShadowCullingD3D12::ResetCameraSpeeds()
{
    m_baseMoveSpeed = 17.0f;
    m_fastMoveSpeed = 58.2f;
}

void BistroExteriorMeshShaderShadowCullingD3D12::ResetShadowSettings()
{
...
void BistroExteriorMeshShaderShadowCullingD3D12::AllocateImGuiDescriptor(ImGui_ImplDX12_InitInfo* info, D3D12_CPU_DESCRIPTOR_HANDLE* outCpuHandle, D3D12_GPU_DESCRIPTOR_HANDLE* outGpuHandle)
{
    auto* sample = static_cast<BistroExteriorMeshShaderShadowCullingD3D12*>(info->UserData);
...
void BistroExteriorMeshShaderShadowCullingD3D12::FreeImGuiDescriptor(ImGui_ImplDX12_InitInfo*, D3D12_CPU_DESCRIPTOR_HANDLE, D3D12_GPU_DESCRIPTOR_HANDLE)
{
}
