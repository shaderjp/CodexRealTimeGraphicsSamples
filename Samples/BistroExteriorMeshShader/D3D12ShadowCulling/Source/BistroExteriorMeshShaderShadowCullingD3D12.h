...
class BistroExteriorMeshShaderShadowCullingD3D12 : public DXSample
{
public:
    BistroExteriorMeshShaderShadowCullingD3D12(UINT width, UINT height, std::wstring name);
