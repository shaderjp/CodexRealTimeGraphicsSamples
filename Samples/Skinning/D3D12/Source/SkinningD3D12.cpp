...
SkinningD3D12::SkinningD3D12(UINT width, UINT height, std::wstring name) :
...
void SkinningD3D12::LoadPipeline()
{
...
void SkinningD3D12::LoadAssets()
{
    ...
    rootParameters[1].InitAsDescriptorTable(1, &cbvRange1, D3D12_SHADER_VISIBILITY_VERTEX);
    ...
    ThrowIfFailed(ReadDataFromFile(GetAssetFullPath(L"Skinning.vs.cso").c_str(), &vertexShaderData, &vertexShaderDataLength));
    ThrowIfFailed(ReadDataFromFile(GetAssetFullPath(L"Skinning.ps.cso").c_str(), &pixelShaderData, &pixelShaderDataLength));
    ...
    D3D12_INPUT_ELEMENT_DESC inputElementDescs[] =
    {
        ...
        { "BLENDINDICES", 0, DXGI_FORMAT_R32G32B32A32_UINT, 0, offsetof(Vertex, joints), D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
        { "BLENDWEIGHT", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, offsetof(Vertex, weights), D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
    };
...
void SkinningD3D12::OnUpdate()
{
    UpdateAnimation();
}

void SkinningD3D12::OnRender()
{
    PopulateCommandList();
    ID3D12CommandList* commandLists[] = { m_commandList.Get() };
    m_commandQueue->ExecuteCommandLists(_countof(commandLists), commandLists);
...
void SkinningD3D12::LoadModel()
{
    ...
    for (uint32_t i = 0; i < SkinningData::VertexCount; ++i)
    {
        ...
        m_vertices[i] = { positions[i], normals[i], texcoords[i], XMUINT4(joint[0], joint[1], joint[2], joint[3]), weights[i] };
    }
...
SkinningD3D12::ImageData SkinningD3D12::LoadTexture(const std::wstring& path) const
{
...
void SkinningD3D12::CreateTexture(const ImageData& image)
{
...
void SkinningD3D12::PopulateCommandList()
{
...
void SkinningD3D12::WaitForPreviousFrame()
{
...
XMMATRIX SkinningD3D12::GetLocalMatrix(UINT nodeIndex) const
{
...
void SkinningD3D12::UpdateAnimation()
{
...
void SkinningD3D12::UpdateConstantBuffers()
{
