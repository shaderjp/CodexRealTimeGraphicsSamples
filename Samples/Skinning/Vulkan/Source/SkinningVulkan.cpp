...
namespace
{
    ...
    const std::array<const wchar_t*, SkinningVulkan::TextureCount> TextureNames =
    {
...
bool SkinningVulkan::QueueFamilyIndices::IsComplete() const
{
    return graphicsFamily != UINT32_MAX && presentFamily != UINT32_MAX;
}

SkinningVulkan::SkinningVulkan(uint32_t width, uint32_t height, const wchar_t* title) :
    m_width(width),
    m_height(height),
    m_title(title)
{
...
SkinningVulkan::~SkinningVulkan()
{
    Cleanup();
}

int SkinningVulkan::Run(HINSTANCE instance, int showCommand)
{
...
LRESULT CALLBACK SkinningVulkan::WindowProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
...
void SkinningVulkan::InitWindow(HINSTANCE instance, int showCommand)
{
    ...
    windowClass.lpszClassName = L"SkinningVulkanWindowClass";
...
void SkinningVulkan::InitVulkan()
{
    LoadModel();
    CreateInstance();
    CreateSurface();
...
void SkinningVulkan::CreateInstance()
{
    VkApplicationInfo appInfo{};
    appInfo.sType = VK_STRUCTURE_TYPE_APPLICATION_INFO;
    appInfo.pApplicationName = "Skinning Vulkan";
...
void SkinningVulkan::CreateSurface()
{
...
void SkinningVulkan::PickPhysicalDevice()
{
...
void SkinningVulkan::CreateLogicalDevice()
{
...
void SkinningVulkan::CreateSwapChain()
{
...
void SkinningVulkan::CreateImageViews()
{
...
void SkinningVulkan::CreateRenderPass()
{
...
void SkinningVulkan::CreateDescriptorSetLayout()
{
...
void SkinningVulkan::CreateGraphicsPipeline()
{
    std::wstring shaderDirectory = GetExecutableDirectory();
    VkShaderModule vertexShaderModule = CreateShaderModule(ReadFile(shaderDirectory + L"Skinning.vs.spv"));
    VkShaderModule pixelShaderModule = CreateShaderModule(ReadFile(shaderDirectory + L"Skinning.ps.spv"));
...
void SkinningVulkan::CreateDepthResources()
{
...
void SkinningVulkan::CreateFramebuffers()
{
...
void SkinningVulkan::CreateCommandPool()
{
...
void SkinningVulkan::CreateVertexBuffer()
{
...
void SkinningVulkan::CreateIndexBuffer()
{
...
void SkinningVulkan::CreateTextureImages()
{
    for (uint32_t i = 0; i < TextureCount; ++i)
    {
...
void SkinningVulkan::CreateTextureSampler()
{
...
void SkinningVulkan::CreateUniformBuffer()
{
...
void SkinningVulkan::CreateDescriptorPool()
{
...
void SkinningVulkan::CreateDescriptorSet()
{
...
void SkinningVulkan::CreateCommandBuffers()
{
...
void SkinningVulkan::CreateSyncObjects()
{
...
void SkinningVulkan::UpdateUniformBuffer()
{
...
XMMATRIX SkinningVulkan::GetLocalMatrix(uint32_t nodeIndex) const
{
...
void SkinningVulkan::UpdateAnimation()
{
...
bool SkinningVulkan::IsDeviceSuitable(VkPhysicalDevice device) const
{
...
SkinningVulkan::QueueFamilyIndices SkinningVulkan::FindQueueFamilies(VkPhysicalDevice device) const
{
...
SkinningVulkan::SwapChainSupport SkinningVulkan::QuerySwapChainSupport(VkPhysicalDevice device) const
{
...
VkSurfaceFormatKHR SkinningVulkan::ChooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& formats) const
{
...
VkPresentModeKHR SkinningVulkan::ChooseSwapPresentMode(const std::vector<VkPresentModeKHR>& presentModes) const
{
...
VkExtent2D SkinningVulkan::ChooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) const
{
...
uint32_t SkinningVulkan::FindMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) const
{
...
void SkinningVulkan::CreateBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& memory)
{
...
void SkinningVulkan::CreateImage(uint32_t width, uint32_t height, VkFormat format, VkImageUsageFlags usage, VkImage& image, VkDeviceMemory& memory)
{
...
VkImageView SkinningVulkan::CreateImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) const
{
...
VkCommandBuffer SkinningVulkan::BeginSingleTimeCommands() const
{
    VkCommandBufferAllocateInfo allocateInfo{};
    allocateInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
    allocateInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
...
void SkinningVulkan::EndSingleTimeCommands(VkCommandBuffer commandBuffer) const
{
...
void SkinningVulkan::CopyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) const
{
...
void SkinningVulkan::TransitionImageLayout(VkImage image, VkImageLayout oldLayout, VkImageLayout newLayout) const
{
    VkCommandBuffer commandBuffer = BeginSingleTimeCommands();
...
SkinningVulkan::ImageData SkinningVulkan::LoadTexture(const std::wstring& path) const
{
...
std::vector<char> SkinningVulkan::ReadFile(const std::wstring& path) const
{
...
VkShaderModule SkinningVulkan::CreateShaderModule(const std::vector<char>& code) const
{
...
std::wstring SkinningVulkan::GetExecutableDirectory() const
{
...
void SkinningVulkan::ThrowIfFailed(VkResult result, const char* message) const
{
