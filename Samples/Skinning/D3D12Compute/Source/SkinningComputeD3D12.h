...
class SkinningComputeD3D12 : public DXSample
{
public:
    struct Vertex
    {
        XMFLOAT4 positionTexcoordX;
        XMFLOAT4 normalTexcoordY;
        XMUINT4 joints;
        XMFLOAT4 weights;
    };
    ...
    SkinningComputeD3D12(UINT width, UINT height, std::wstring name);
...
private:
    ...
    ComPtr<ID3D12Resource> m_sourceVertexBuffer;
    ComPtr<ID3D12Resource> m_skinnedVertexBuffer;
