...
void BistroExteriorPathtracingD3D12::UpdateConstantBuffer(float)
{
    ...
    constants.restirEnhancedOptions2 = XMFLOAT4(m_enhancedForcedNeeReconnection ? 1.0f : 0.0f, m_enhancedTemporalCapDefault, m_enhancedTemporalCapMin, m_enhancedDuplicationAlpha);
