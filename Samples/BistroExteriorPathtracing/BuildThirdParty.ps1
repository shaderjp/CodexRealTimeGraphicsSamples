...
Invoke-WithMutex -Name "Local\CodexdBistroExteriorPathtracingAssimp-$Configuration" -Body {
...
Invoke-WithMutex -Name "Local\CodexdBistroExteriorPathtracingDirectXTex-$Configuration" -Body {
