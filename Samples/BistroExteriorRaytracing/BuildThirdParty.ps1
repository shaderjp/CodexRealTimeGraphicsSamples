...
Invoke-WithMutex -Name "Local\CodexdBistroExteriorRaytracingAssimp-$Configuration" -Body {
...
Invoke-WithMutex -Name "Local\CodexdBistroExteriorRaytracingDirectXTex-$Configuration" -Body {
