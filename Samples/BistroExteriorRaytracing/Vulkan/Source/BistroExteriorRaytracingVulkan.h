...
enum class BistroRaytracingMode
{
    Direct,
    Shadow,
    GI
...
class BistroExteriorRaytracingVulkan
{
public:
    BistroExteriorRaytracingVulkan(uint32_t width, uint32_t height, const wchar_t* title, BistroRaytracingMode mode);
...
private:
    ...
    uint32_t m_height;
    std::wstring m_title;
    BistroRaytracingMode m_mode = BistroRaytracingMode::Direct;
    HWND m_hwnd = nullptr;
