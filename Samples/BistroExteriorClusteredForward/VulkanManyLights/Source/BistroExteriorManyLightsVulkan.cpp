...
bool BistroExteriorManyLightsVulkan::QueueFamilyIndices::IsComplete() const
{
    return graphicsFamily != UINT32_MAX && presentFamily != UINT32_MAX;
}

BistroExteriorManyLightsVulkan::BistroExteriorManyLightsVulkan(uint32_t width, uint32_t height, const wchar_t* title) :
    m_width(width),
    m_height(height),
    m_title(title)
{
...
BistroExteriorManyLightsVulkan::~BistroExteriorManyLightsVulkan()
{
    Cleanup();
}

int BistroExteriorManyLightsVulkan::Run(HINSTANCE instance, int showCommand)
{
...
LRESULT CALLBACK BistroExteriorManyLightsVulkan::WindowProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    BistroExteriorManyLightsVulkan* app = reinterpret_cast<BistroExteriorManyLightsVulkan*>(GetWindowLongPtr(hwnd, GWLP_USERDATA));
    if (message == WM_NCCREATE)
    {
        auto* createStruct = reinterpret_cast<CREATESTRUCT*>(lParam);
        app = reinterpret_cast<BistroExteriorManyLightsVulkan*>(createStruct->lpCreateParams);
...
void BistroExteriorManyLightsVulkan::InitWindow(HINSTANCE instance, int showCommand)
{
    ...
    windowClass.lpszClassName = L"BistroExteriorManyLightsVulkanWindowClass";
...
void BistroExteriorManyLightsVulkan::InitVulkan()
{
    LoadModel();
    CreateInstance();
    CreateSurface();
...
void BistroExteriorManyLightsVulkan::MainLoop()
{
    MSG message{};
...
void BistroExteriorManyLightsVulkan::Render()
{
...
void BistroExteriorManyLightsVulkan::Cleanup()
{
    if (m_device != VK_NULL_HANDLE)
    {
        vkDeviceWaitIdle(m_device);
...
void BistroExteriorManyLightsVulkan::CreateInstance()
{
    VkApplicationInfo appInfo{};
    appInfo.sType = VK_STRUCTURE_TYPE_APPLICATION_INFO;
    appInfo.pApplicationName = "BistroExteriorManyLights Vulkan";
...
void BistroExteriorManyLightsVulkan::CreateSurface()
{
...
void BistroExteriorManyLightsVulkan::PickPhysicalDevice()
{
...
void BistroExteriorManyLightsVulkan::CreateLogicalDevice()
{
...
void BistroExteriorManyLightsVulkan::CreateSwapChain()
{
...
void BistroExteriorManyLightsVulkan::CreateImageViews()
{
...
void BistroExteriorManyLightsVulkan::CreateRenderPass()
{
...
void BistroExteriorManyLightsVulkan::CreateShadowRenderPass()
{
    VkAttachmentDescription depthAttachment{};
    depthAttachment.format = DepthFormat;
    depthAttachment.samples = VK_SAMPLE_COUNT_1_BIT;
...
void BistroExteriorManyLightsVulkan::CreateDescriptorSetLayout()
{
...
void BistroExteriorManyLightsVulkan::CreateGraphicsPipeline()
{
...
void BistroExteriorManyLightsVulkan::CreateShadowPipeline()
{
    if (m_shadowPipeline)
    {
...
void BistroExteriorManyLightsVulkan::CreateComputePipeline()
{
...
void BistroExteriorManyLightsVulkan::CreateDepthResources()
{
...
void BistroExteriorManyLightsVulkan::CreateShadowResources()
{
    CreateImage(
        m_shadowResolution,
        m_shadowResolution,
...
void BistroExteriorManyLightsVulkan::DestroyShadowResources()
{
...
void BistroExteriorManyLightsVulkan::RecreateShadowResources()
{
    vkDeviceWaitIdle(m_device);
    DestroyShadowResources();
    CreateShadowResources();
...
void BistroExteriorManyLightsVulkan::CreateFramebuffers()
{
...
void BistroExteriorManyLightsVulkan::CreateCommandPool()
{
...
void BistroExteriorManyLightsVulkan::LoadModel()
{
...
void BistroExteriorManyLightsVulkan::CreateVertexBuffer()
{
...
void BistroExteriorManyLightsVulkan::CreateIndexBuffer()
{
...
uint32_t BistroExteriorManyLightsVulkan::CreateTextureResource(const std::wstring& path, bool srgb, const uint8_t fallback[4], std::map<std::wstring, uint32_t>& cache)
{
...
void BistroExteriorManyLightsVulkan::CreateTextureImages()
{
...
void BistroExteriorManyLightsVulkan::CreateTextureSampler()
{
    VkSamplerCreateInfo samplerInfo{};
    samplerInfo.sType = VK_STRUCTURE_TYPE_SAMPLER_CREATE_INFO;
    samplerInfo.magFilter = VK_FILTER_LINEAR;
...
void BistroExteriorManyLightsVulkan::CreateUniformBuffer()
{
...
void BistroExteriorManyLightsVulkan::CreateLightBuffer()
{
...
void BistroExteriorManyLightsVulkan::CreateClusterBuffers()
{
...
void BistroExteriorManyLightsVulkan::CreateDescriptorPool()
{
...
void BistroExteriorManyLightsVulkan::CreateDescriptorSets()
{
...
void BistroExteriorManyLightsVulkan::UpdateShadowDescriptorSets()
{
...
void BistroExteriorManyLightsVulkan::InitializeImGui()
{
    IMGUI_CHECKVERSION();
    ImGui::CreateContext();
...
void BistroExteriorManyLightsVulkan::ShutdownImGui()
{
...
void BistroExteriorManyLightsVulkan::BuildUI()
{
...
void BistroExteriorManyLightsVulkan::BuildRendererStatsUI()
{
...
void BistroExteriorManyLightsVulkan::ResetLight()
{
...
void BistroExteriorManyLightsVulkan::ResetCameraView()
{
    m_camera.Reset(m_defaultCameraPosition, m_defaultCameraYaw, m_defaultCameraPitch);
}

void BistroExteriorManyLightsVulkan::ResetCameraSpeeds()
{
    m_baseMoveSpeed = 17.0f;
    m_fastMoveSpeed = 58.2f;
}

void BistroExteriorManyLightsVulkan::ResetShadowSettings()
{
...
void BistroExteriorManyLightsVulkan::CreateCommandBuffers()
{
...
void BistroExteriorManyLightsVulkan::RecordCommandBuffer(uint32_t imageIndex)
{
...
void BistroExteriorManyLightsVulkan::RecordClusterBuild(VkCommandBuffer commandBuffer)
{
#if BISTRO_CLUSTERED_FORWARD
...
void BistroExteriorManyLightsVulkan::CreateSyncObjects()
{
...
void BistroExteriorManyLightsVulkan::UpdateUniformBuffer()
{
...
void BistroExteriorManyLightsVulkan::ReadbackClusterStats()
{
#if BISTRO_CLUSTERED_FORWARD
...
bool BistroExteriorManyLightsVulkan::IsDeviceSuitable(VkPhysicalDevice device) const
{
...
BistroExteriorManyLightsVulkan::QueueFamilyIndices BistroExteriorManyLightsVulkan::FindQueueFamilies(VkPhysicalDevice device) const
{
...
BistroExteriorManyLightsVulkan::SwapChainSupport BistroExteriorManyLightsVulkan::QuerySwapChainSupport(VkPhysicalDevice device) const
{
...
VkSurfaceFormatKHR BistroExteriorManyLightsVulkan::ChooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& formats) const
{
...
VkPresentModeKHR BistroExteriorManyLightsVulkan::ChooseSwapPresentMode(const std::vector<VkPresentModeKHR>& presentModes) const
{
...
VkExtent2D BistroExteriorManyLightsVulkan::ChooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) const
{
...
uint32_t BistroExteriorManyLightsVulkan::FindMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) const
{
...
void BistroExteriorManyLightsVulkan::CreateBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& memory)
{
...
void BistroExteriorManyLightsVulkan::CreateImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkFormat format, VkImageUsageFlags usage, VkImage& image, VkDeviceMemory& memory)
{
...
VkImageView BistroExteriorManyLightsVulkan::CreateImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLevels) const
{
...
VkCommandBuffer BistroExteriorManyLightsVulkan::BeginSingleTimeCommands() const
{
    VkCommandBufferAllocateInfo allocateInfo{};
    allocateInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
    allocateInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
...
void BistroExteriorManyLightsVulkan::EndSingleTimeCommands(VkCommandBuffer commandBuffer) const
{
...
void BistroExteriorManyLightsVulkan::CopyBufferToImage(VkBuffer buffer, VkImage image, const Bistro::TextureData& texture) const
{
...
void BistroExteriorManyLightsVulkan::TransitionImageLayout(VkImage image, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLevels) const
{
    VkCommandBuffer commandBuffer = BeginSingleTimeCommands();
...
std::vector<char> BistroExteriorManyLightsVulkan::ReadFile(const std::wstring& path) const
{
...
VkShaderModule BistroExteriorManyLightsVulkan::CreateShaderModule(const std::vector<char>& code) const
{
...
std::wstring BistroExteriorManyLightsVulkan::GetExecutableDirectory() const
{
...
void BistroExteriorManyLightsVulkan::ThrowIfFailed(VkResult result, const char* message) const
{
