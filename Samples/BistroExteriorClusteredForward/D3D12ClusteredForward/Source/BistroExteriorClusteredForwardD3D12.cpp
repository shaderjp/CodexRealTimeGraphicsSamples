#include "stdafx.h"
#include "BistroExteriorClusteredForwardD3D12.h"
...
BistroExteriorClusteredForwardD3D12::BistroExteriorClusteredForwardD3D12(UINT width, UINT height, std::wstring name) :
...
void BistroExteriorClusteredForwardD3D12::OnInit()
{
    LoadPipeline();
    LoadAssets();
...
void BistroExteriorClusteredForwardD3D12::LoadPipeline()
{
...
void BistroExteriorClusteredForwardD3D12::LoadAssets()
{
...
void BistroExteriorClusteredForwardD3D12::CreateRootSignature()
{
...
void BistroExteriorClusteredForwardD3D12::CreatePipelineState()
{
...
void BistroExteriorClusteredForwardD3D12::CreateComputePipelineStates()
{
...
void BistroExteriorClusteredForwardD3D12::CreateBuffers()
{
...
void BistroExteriorClusteredForwardD3D12::CreateLightAndClusterBuffers()
{
...
void BistroExteriorClusteredForwardD3D12::CreateShadowResources()
{
...
UINT BistroExteriorClusteredForwardD3D12::CreateTextureResource(const std::wstring& path, bool srgb, const uint8_t fallback[4], std::map<std::wstring, UINT>& cache)
{
...
void BistroExteriorClusteredForwardD3D12::CreateTextures()
{
...
void BistroExteriorClusteredForwardD3D12::OnUpdate()
{
    BuildUI();
...
void BistroExteriorClusteredForwardD3D12::UpdateConstantBuffer(float deltaSeconds)
{
...
void BistroExteriorClusteredForwardD3D12::OnRender()
{
    PopulateCommandList();
    ID3D12CommandList* commandLists[] = { m_commandList.Get() };
    m_commandQueue->ExecuteCommandLists(_countof(commandLists), commandLists);
...
void BistroExteriorClusteredForwardD3D12::PopulateCommandList()
{
...
void BistroExteriorClusteredForwardD3D12::DrawScene()
{
...
void BistroExteriorClusteredForwardD3D12::DispatchClusterBuild()
{
#if BISTRO_CLUSTERED_FORWARD
...
void BistroExteriorClusteredForwardD3D12::ReadbackClusterStats()
{
#if BISTRO_CLUSTERED_FORWARD
...
void BistroExteriorClusteredForwardD3D12::OnDestroy()
{
    WaitForPreviousFrame();
    ShutdownImGui();
...
void BistroExteriorClusteredForwardD3D12::WaitForPreviousFrame()
{
...
void BistroExteriorClusteredForwardD3D12::ResizeOutput(UINT width, UINT height)
{
...
void BistroExteriorClusteredForwardD3D12::OnKeyDown(UINT8 key)
{
    if (key == VK_ESCAPE)
    {
...
void BistroExteriorClusteredForwardD3D12::OnWindowMessage(UINT message, WPARAM wParam, LPARAM lParam)
{
...
void BistroExteriorClusteredForwardD3D12::InitializeImGui()
{
    IMGUI_CHECKVERSION();
    ImGui::CreateContext();
...
void BistroExteriorClusteredForwardD3D12::ShutdownImGui()
{
...
void BistroExteriorClusteredForwardD3D12::BuildUI()
{
...
void BistroExteriorClusteredForwardD3D12::BuildRendererStatsUI()
{
...
void BistroExteriorClusteredForwardD3D12::ResetLight()
{
...
void BistroExteriorClusteredForwardD3D12::ResetCameraView()
{
    m_camera.Reset(m_defaultCameraPosition, m_defaultCameraYaw, m_defaultCameraPitch);
}

void BistroExteriorClusteredForwardD3D12::ResetCameraSpeeds()
{
    m_baseMoveSpeed = 17.0f;
    m_fastMoveSpeed = 58.2f;
}

void BistroExteriorClusteredForwardD3D12::ResetShadowSettings()
{
...
void BistroExteriorClusteredForwardD3D12::AllocateImGuiDescriptor(ImGui_ImplDX12_InitInfo* info, D3D12_CPU_DESCRIPTOR_HANDLE* outCpuHandle, D3D12_GPU_DESCRIPTOR_HANDLE* outGpuHandle)
{
    auto* sample = static_cast<BistroExteriorClusteredForwardD3D12*>(info->UserData);
...
void BistroExteriorClusteredForwardD3D12::FreeImGuiDescriptor(ImGui_ImplDX12_InitInfo*, D3D12_CPU_DESCRIPTOR_HANDLE, D3D12_GPU_DESCRIPTOR_HANDLE)
{
}
