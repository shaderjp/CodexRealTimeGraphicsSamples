...
Invoke-WithMutex -Name "Local\CodexdBistroInteriorPathtracingAssimp-$Configuration" -Body {
...
Invoke-WithMutex -Name "Local\CodexdBistroInteriorPathtracingDirectXTex-$Configuration" -Body {
