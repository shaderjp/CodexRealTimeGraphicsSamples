...
namespace
{
    ...
    const std::wstring SceneFbxName = L"BistroInterior.fbx";
...
bool BistroInteriorPathtracingVulkan::QueueFamilyIndices::IsComplete() const
{
    return graphicsFamily != UINT32_MAX && presentFamily != UINT32_MAX;
}

BistroInteriorPathtracingVulkan::BistroInteriorPathtracingVulkan(uint32_t width, uint32_t height, const wchar_t* title, BistroPathtracingMode mode) :
    m_width(width),
    m_height(height),
    m_title(title),
    m_mode(mode)
...
BistroInteriorPathtracingVulkan::~BistroInteriorPathtracingVulkan()
{
    Cleanup();
}

int BistroInteriorPathtracingVulkan::Run(HINSTANCE instance, int showCommand)
{
...
LRESULT CALLBACK BistroInteriorPathtracingVulkan::WindowProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    auto* app = reinterpret_cast<BistroInteriorPathtracingVulkan*>(GetWindowLongPtr(hwnd, GWLP_USERDATA));
    if (message == WM_NCCREATE)
    {
        auto* createStruct = reinterpret_cast<CREATESTRUCT*>(lParam);
        app = reinterpret_cast<BistroInteriorPathtracingVulkan*>(createStruct->lpCreateParams);
...
void BistroInteriorPathtracingVulkan::InitWindow(HINSTANCE instance, int showCommand)
{
    ...
    windowClass.lpszClassName = L"BistroInteriorPathtracingVulkanWindow";
...
void BistroInteriorPathtracingVulkan::InitVulkan()
{
    CreateInstance();
    CreateSurface();
    PickPhysicalDevice();
...
void BistroInteriorPathtracingVulkan::MainLoop()
{
    MSG msg{};
...
void BistroInteriorPathtracingVulkan::Render()
{
...
void BistroInteriorPathtracingVulkan::SetOutputResolution(uint32_t width, uint32_t height)
{
...
void BistroInteriorPathtracingVulkan::RecreateSwapChain()
{
...
void BistroInteriorPathtracingVulkan::WaitIdle()
{
...
void BistroInteriorPathtracingVulkan::Cleanup()
{
    if (m_device == VK_NULL_HANDLE)
    {
        return;
...
void BistroInteriorPathtracingVulkan::CreateInstance()
{
    VkApplicationInfo appInfo{};
    appInfo.sType = VK_STRUCTURE_TYPE_APPLICATION_INFO;
    appInfo.pApplicationName = "BistroInteriorPathtracing";
...
void BistroInteriorPathtracingVulkan::CreateSurface()
{
...
void BistroInteriorPathtracingVulkan::PickPhysicalDevice()
{
    ...
    {
        throw std::runtime_error("No suitable Vulkan device was found. BistroInteriorPathtracingVulkan requires Vulkan 1.2, swapchain support, and KHR Path Tracing features.");
    }
...
void BistroInteriorPathtracingVulkan::CreateLogicalDevice()
{
...
void BistroInteriorPathtracingVulkan::LoadRayTracingFunctions()
{
...
void BistroInteriorPathtracingVulkan::CreateSwapChain()
{
...
void BistroInteriorPathtracingVulkan::CreateImageViews()
{
...
void BistroInteriorPathtracingVulkan::CreateRenderPass()
{
...
void BistroInteriorPathtracingVulkan::CreateFramebuffers()
{
...
void BistroInteriorPathtracingVulkan::CreateCommandPool()
{
...
void BistroInteriorPathtracingVulkan::LoadModel()
{
    m_scene = Bistro::LoadScene(Bistro::FindAssetRoot(SceneFbxName), SceneFbxName);
    if (m_scene.draws.empty())
    {
        throw std::runtime_error("BistroInterior.fbx did not produce Path Tracing geometries.");
    }
    Bistro::LightBuildResult lightBuild = Bistro::BuildLightList(m_scene, 4096);
    ...
    const DirectX::XMFLOAT3 extent(
        (std::max)(m_scene.boundsMax.x - m_scene.boundsMin.x, 1.0f),
        (std::max)(m_scene.boundsMax.y - m_scene.boundsMin.y, 1.0f),
        (std::max)(m_scene.boundsMax.z - m_scene.boundsMin.z, 1.0f));
    ...
    m_defaultCameraPosition = DirectX::XMFLOAT3(center.x, m_scene.boundsMin.y + extent.y * 0.38f, center.z - extent.z * 0.28f);
    m_defaultCameraYaw = 0.0f;
    m_defaultCameraPitch = DirectX::XMConvertToRadians(-1.5f);
    ResetCameraView();
    ResetCameraSpeeds();
}

void BistroInteriorPathtracingVulkan::CreateOutputImages()
{
...
void BistroInteriorPathtracingVulkan::CreateSceneBuffers()
{
...
uint32_t BistroInteriorPathtracingVulkan::CreateTextureResource(const std::wstring& path, bool srgb, const uint8_t fallback[4], std::map<std::wstring, uint32_t>& cache)
{
...
void BistroInteriorPathtracingVulkan::CreateTextureImages()
{
...
void BistroInteriorPathtracingVulkan::CreateTextureSampler()
{
...
void BistroInteriorPathtracingVulkan::CreateDescriptorSetLayouts()
{
...
void BistroInteriorPathtracingVulkan::CreateDescriptorPool()
{
    const uint32_t textureDescriptorCount = (std::max)(1u, static_cast<uint32_t>(m_scene.materials.size() * TextureSlotCount + 1u));
...
void BistroInteriorPathtracingVulkan::CreateDescriptorSets()
{
...
void BistroInteriorPathtracingVulkan::CreateRayTracingPipeline()
{
...
void BistroInteriorPathtracingVulkan::CreateRestirReusePipeline()
{
...
void BistroInteriorPathtracingVulkan::CreateDenoisePipeline()
{
...
void BistroInteriorPathtracingVulkan::CreateShaderBindingTables()
{
...
void BistroInteriorPathtracingVulkan::BuildAccelerationStructures()
{
...
void BistroInteriorPathtracingVulkan::CreateCommandBuffers()
{
...
void BistroInteriorPathtracingVulkan::RecordCommandBuffer(uint32_t imageIndex)
{
...
void BistroInteriorPathtracingVulkan::RecordRestirReusePass(VkCommandBuffer commandBuffer)
{
...
void BistroInteriorPathtracingVulkan::RecordDenoisePass(VkCommandBuffer commandBuffer)
{
...
void BistroInteriorPathtracingVulkan::CreateSyncObjects()
{
...
void BistroInteriorPathtracingVulkan::InitializeImGui()
{
    IMGUI_CHECKVERSION();
    ImGui::CreateContext();
...
void BistroInteriorPathtracingVulkan::ShutdownImGui()
{
...
void BistroInteriorPathtracingVulkan::BuildUI()
{
...
void BistroInteriorPathtracingVulkan::BuildRendererStatsUI()
{
...
void BistroInteriorPathtracingVulkan::ResetLight()
{
    m_lightDirection[0] = -0.25f;
    m_lightDirection[1] = -0.85f;
    m_lightDirection[2] = 0.35f;
    m_lightColor[0] = 1.0f;
...
void BistroInteriorPathtracingVulkan::ResetCameraView()
{
    m_camera.Reset(m_defaultCameraPosition, m_defaultCameraYaw, m_defaultCameraPitch);
}

void BistroInteriorPathtracingVulkan::ResetCameraSpeeds()
{
    m_baseMoveSpeed = 4.0f;
    m_fastMoveSpeed = 14.0f;
    m_camera.SetMoveSpeeds(m_baseMoveSpeed, m_fastMoveSpeed);
}

void BistroInteriorPathtracingVulkan::ResetAccumulation()
{
    m_accumulatedFrames = 0;
    m_resetAccumulationRequested = true;
}

bool BistroInteriorPathtracingVulkan::HasAccumulationStateChanged()
{
    DirectX::XMFLOAT3 cameraPosition = m_camera.GetPosition();
...
void BistroInteriorPathtracingVulkan::UpdateUniformBuffer(float)
{
...
bool BistroInteriorPathtracingVulkan::IsDeviceSuitable(VkPhysicalDevice device) const
{
...
BistroInteriorPathtracingVulkan::QueueFamilyIndices BistroInteriorPathtracingVulkan::FindQueueFamilies(VkPhysicalDevice device) const
{
...
BistroInteriorPathtracingVulkan::SwapChainSupport BistroInteriorPathtracingVulkan::QuerySwapChainSupport(VkPhysicalDevice device) const
{
...
VkSurfaceFormatKHR BistroInteriorPathtracingVulkan::ChooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& formats) const
{
...
VkPresentModeKHR BistroInteriorPathtracingVulkan::ChooseSwapPresentMode(const std::vector<VkPresentModeKHR>& presentModes) const
{
...
VkExtent2D BistroInteriorPathtracingVulkan::ChooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) const
{
...
uint32_t BistroInteriorPathtracingVulkan::FindMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) const
{
...
void BistroInteriorPathtracingVulkan::CreateBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, GpuBuffer& buffer)
{
    buffer.size = size;
...
void BistroInteriorPathtracingVulkan::DestroyBuffer(GpuBuffer& buffer)
{
...
void BistroInteriorPathtracingVulkan::UploadBuffer(const void* data, VkDeviceSize size, VkBufferUsageFlags usage, GpuBuffer& destination)
{
    GpuBuffer staging;
...
VkDeviceAddress BistroInteriorPathtracingVulkan::GetBufferAddress(VkBuffer buffer) const
{
...
void BistroInteriorPathtracingVulkan::CreateImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkFormat format, VkImageUsageFlags usage, VkImage& image, VkDeviceMemory& memory)
{
...
VkImageView BistroInteriorPathtracingVulkan::CreateImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLevels) const
{
...
VkCommandBuffer BistroInteriorPathtracingVulkan::BeginSingleTimeCommands() const
{
    VkCommandBufferAllocateInfo allocateInfo{};
    allocateInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
    allocateInfo.commandPool = m_commandPool;
...
void BistroInteriorPathtracingVulkan::EndSingleTimeCommands(VkCommandBuffer commandBuffer) const
{
...
void BistroInteriorPathtracingVulkan::CopyBuffer(VkBuffer src, VkBuffer dst, VkDeviceSize size) const
{
    VkCommandBuffer commandBuffer = BeginSingleTimeCommands();
    VkBufferCopy copyRegion{};
...
void BistroInteriorPathtracingVulkan::CopyBufferToImage(VkBuffer buffer, VkImage image, const Bistro::TextureData& texture) const
{
    VkCommandBuffer commandBuffer = BeginSingleTimeCommands();
...
void BistroInteriorPathtracingVulkan::TransitionImageLayout(VkCommandBuffer commandBuffer, VkImage image, VkImageLayout oldLayout, VkImageLayout newLayout, VkImageAspectFlags aspectMask, VkPipelineStageFlags srcStage, VkPipelineStageFlags dstStage) const
{
...
void BistroInteriorPathtracingVulkan::TransitionImageLayoutImmediate(VkImage image, VkImageLayout oldLayout, VkImageLayout newLayout, VkImageAspectFlags aspectMask) const
{
    VkCommandBuffer commandBuffer = BeginSingleTimeCommands();
...
std::vector<char> BistroInteriorPathtracingVulkan::ReadFile(const std::wstring& path) const
{
...
VkShaderModule BistroInteriorPathtracingVulkan::CreateShaderModule(const std::vector<char>& code) const
{
...
std::wstring BistroInteriorPathtracingVulkan::GetExecutableDirectory() const
{
...
std::wstring BistroInteriorPathtracingVulkan::ShaderFileName() const
{
    if (m_mode == BistroPathtracingMode::ReSTIR)
    {
        return L"BistroInteriorPathtracingReSTIR.spv";
    }
    if (m_mode == BistroPathtracingMode::ReSTIRDI)
    {
        return L"BistroInteriorPathtracingReSTIRDI.spv";
    }
    return L"BistroInteriorPathtracing.spv";
}

std::wstring BistroInteriorPathtracingVulkan::RestirReuseShaderFileName() const
{
    return L"BistroInteriorPathtracingReSTIRResolve.spv";
}

std::wstring BistroInteriorPathtracingVulkan::DenoiseShaderFileName() const
{
    return L"BistroInteriorPathtracingDenoise.spv";
}

uint32_t BistroInteriorPathtracingVulkan::MaxTraceRecursionDepth() const
{
    return 1u;
}

VkDeviceSize BistroInteriorPathtracingVulkan::Align(VkDeviceSize value, VkDeviceSize alignment) const
{
    return (value + alignment - 1) & ~(alignment - 1);
}

void BistroInteriorPathtracingVulkan::ThrowIfFailed(VkResult result, const char* message) const
{
