...
class BistroInteriorPathtracingVulkan
{
public:
    BistroInteriorPathtracingVulkan(uint32_t width, uint32_t height, const wchar_t* title, BistroPathtracingMode mode);
...
private:
    ...
    DirectX::XMFLOAT3 m_defaultCameraPosition = DirectX::XMFLOAT3(0.0f, 2.0f, -5.0f);
